...
Deno.test(
  'getRequestUrl - applies multiple query params correctly with sort param',
  async () => {
    assertEquals(
      decodeURIComponent(
        airtable.getRequestUrl({
          ...
          maxRecords: '50',
          pageSize: 30,
          sort: [{ field: 'Founder Name' }],
        })
      ),
      "https://api.airtable.com/v0/appXXXXXXXXXXXXXX/Humans?filterByFormula={Age}='27'&maxRecords=50&pageSize=30&sort[0][field]=Founder Name"
    );
  }
);
